...
app.layout = html.Div(
    children=[html.H1(children='Twitter Analysis Dashboard', style={'textAlign': 'center', 'color': '#0F562F'}),
              html.Br(),
              html.Label('Select Original Language'),
              dcc.Dropdown(id='lang_sel', options=[{'label': i, 'value': i} for i in lang_lst], value='en',
